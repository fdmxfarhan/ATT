...
while (1)
      ...
      if(tsop<500) 
        ...
        {
        if(num==0)   motor(255,255,-255,-255);
        else if(num==2)   motor(255,-255,-255,255);
        else if(num==4)   motor(0,-255,0,255);
        else if(num==6)   motor(-255,-255,255,255);
        else if(num==8)   motor(-255,0,255,0);
        else if(num==10)   motor(-255,0,255,0);
        else if(num==12)  motor(-255,0,255,0);
        else if(num==14)  motor(-255,255,255,-255);
        else if(num==1)  motor(255,-128.-255,128);
        else if(num==3)  motor(128,-255,-128,255);
        else if(num==5)  motor(-128,-255,128,255);
        else if(num==7)  motor(-255,-128,255,128);
        else if(num==9)  motor(-255,-128,255,128);
        else if(num==11)  motor(-255,-128,255,128);
        else if(num==13)  motor(-255,128,255,-128);
        else if(num==15)  motor(-128,255,128,-255);
