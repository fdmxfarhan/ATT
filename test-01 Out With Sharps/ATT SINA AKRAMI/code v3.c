...
void move(int a)
{
if(a==0)   motor(255,255,-255,-255);
        else if(a==4)   motor(255+cmp,-255+cmp,-255+cmp,255+cmp);
        else if(a==6)   motor(0+cmp,-255+cmp,0+cmp,255+cmp);
        else if(a==8)   motor(-255+cmp,-255+cmp,255+cmp,255+cmp);
        else if(a==10)   motor(-255+cmp,0+cmp,255+cmp,0+cmp);
        else if(a==12)  motor(-255+cmp,255+cmp,255+cmp,-255+cmp);
        else if(a==14)  motor(0+cmp,255+cmp,0+cmp,-255+cmp);
        else if(a==1)  motor(255+cmp,128+cmp,-255+cmp,-128+cmp);
        else if(a==3)  motor(255+cmp,-128+cmp,-255+cmp,128+cmp);
        else if(a==5)  motor(128+cmp,-255+cmp,-128+cmp,255+cmp);
        else if(a==7)  motor(-128+cmp,-255+cmp,128+cmp,255+cmp);
        else if(a==9)  motor(-255+cmp,-128+cmp,255+cmp,128+cmp);
        else if(a==11)  motor(-255+cmp,128+cmp,255+cmp,-128+cmp);
        else if(a==13)  motor(-128+cmp,255+cmp,128+cmp,-255+cmp);
        else if(a==15)  motor(128+cmp,255+cmp,-128+cmp,-255+cmp);
}
...
while (1)
    {
    sensor();    //khandan tamam sensorha
    readcmp();   //khandan ghotbnama
    if(tsop<500)
        {  
        if(shr>300)
        {
        ...
        else if(num==1) move(1); 
        else if(num==2) move(3); 
        else if(num==3) move(5); 
        else if(num==4) move(6); 
        else if(num==5) move(7); 
        else if(num==6) move(8); 
        else if(num==7) move(9); 
        else if(num==8) move(10); 
        else if(num==9) move(7); 
        else if(num==10) move(8);
        else if(num==11) move(9); 
        else if(num==12) move(10); 
        else if(num==13) move(11); 
        else if(num==14) move(13); 
        else if(num==15) move(15);           
        ...
        {
        if(shb<250)
        motor(-150+cmp+k,-150+cmp-k,150+cmp-k,150+cmp+k);
        else motor(cmp,cmp,cmp,cmp);
        }  
